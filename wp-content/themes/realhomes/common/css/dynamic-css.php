	...
	function inspiry_property_features_icons_css( $realhomes_common_custom_css ) {
		...
		foreach ( $features_terms as $feature_term ) {
			...
			if ( 'modern' === INSPIRY_DESIGN_VARIATION ) {
				...
				$css .= "
						.rh_property__features_wrap #rh_property__feature_{$term_id} > svg,
						.rh_property__features_wrap #rh_property__feature_{$term_id} > i {
							display: none;
						}
						...
						";
				$css .= is_rtl() ? "margin: 0 -20px 0 5px;" : "margin: 0 5px 0 0;";
				$css .= "}\n";
			} {
				$css .= "
