    ...
    <div class="small-column-wrap">
        ...
        <div class="column column-price">
            ...
            <div class="property-payment-info"><?php
				...
				} else if ( ! class_exists( 'Inspiry_Memberships' ) && $individual_payment_enabled ) {
		...
		<?php else : ?>
			...
			if ( current_user_can( 'delete_posts' ) ) : ?>
                <a class="delete" href="#">
                    ...
                    <a class="remove-property" data-property-id="<?php the_ID(); ?>" href="<?php echo esc_url( admin_url( 'admin-ajax.php' ) ); ?>" title="<?php esc_attr_e( 'Remove This Property', 'framework' ); ?>">
                        <i class="fas fa-check confirm-icon"></i>
                        <i class="fas fa-spinner fa-spin loader hide"></i>
                        <?php esc_html_e( 'Confirm', 'framework' ); ?>
                    </a>
