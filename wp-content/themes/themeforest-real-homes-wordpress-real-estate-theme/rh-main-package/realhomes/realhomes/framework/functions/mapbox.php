...
if ( ! function_exists( 'realhomes_render_properties_on_mapbox' ) ) {
	...
	function realhomes_render_properties_on_mapbox() {
		...
		} elseif ( in_array( $current_page_template, array( 'templates/properties.php', 'templates/list-layout.php', 'templates/list-layout-full-width.php', 'templates/grid-layout.php', 'templates/grid-layout-full-width.php', 'templates/half-map-layout.php' ) ) ) {
