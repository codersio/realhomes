...
if ( is_array($search_fields_to_display) && in_array( 'min-beds', $search_fields_to_display ) ) {
    ...
    <div class="rhea_prop_search__option rhea_prop_search__select rhea_min_beds_field <?php echo esc_attr( $separator_class )?>"
		...
		<select name="bedrooms" id="select-bedrooms-<?php echo esc_attr( $the_widget_id ); ?>"
