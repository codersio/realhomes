	...
	protected function register_controls() {
		...
		$this->add_group_control(
			...
			[
				...
				'label'    => esc_html__( 'Author Name', 'realhomes-elementor-addon' ),
				'scheme'   => \Elementor\Core\Schemes\Typography::TYPOGRAPHY_1,
				'selector' => '{{WRAPPER}} .rhea-ultra-testimonal-author .rhea-author, {{WRAPPER}} .rhea-testimonials-container .rhea-testimonial-author-name',
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'label'    => esc_html__( 'Author Designation', 'realhomes-elementor-addon' ),
				'scheme'   => \Elementor\Core\Schemes\Typography::TYPOGRAPHY_1,
				'selector' => '{{WRAPPER}} .rhea-ultra-testimonal-author .rhea-author-designation, {{WRAPPER}} .rhea-testimonials-container .rhea-testimonial-author-designation',
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'scheme'    => \Elementor\Core\Schemes\Typography::TYPOGRAPHY_1,
				'selector'  => '{{WRAPPER}} .rhea-testimonials-container .rhea-testimonial-text',
				'condition' => [
					'style' => 'carousel',
				],
			]
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .rhea-ultra-testimonal-author .rhea-author, {{WRAPPER}} .rhea-testimonials-container .rhea-testimonial-author-name' => 'margin-bottom: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'   => '',
				'selectors' => [
					'{{WRAPPER}} .rhea-author, {{WRAPPER}} .rhea-testimonials-container .rhea-testimonial-author-name' => 'color: {{VALUE}}',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'   => '',
				'selectors' => [
					'{{WRAPPER}} .rhea-author-designation, {{WRAPPER}} .rhea-testimonials-container .rhea-testimonial-author-designation' => 'color: {{VALUE}}',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'   => '',
				'selectors' => [
					'{{WRAPPER}} .rhea-testimonials-container .rhea-testimonial-text' => 'color: {{VALUE}}',
				],
				'condition' => [
					'style' => 'carousel',
				],
		...
		$this->add_control(
			...
			[
				...
				'default'   => '',
				'selectors' => [
					'{{WRAPPER}} .rhea-testimonials-container .rhea-testimonials-carousel-nav:hover' => 'border-color: {{VALUE}};',
				],
				'condition' => [
					'style' => 'carousel',
				],
		...
		$this->add_control(
			...
			[
				...
				'default'   => '',
				'selectors' => [
					'{{WRAPPER}} .rhea-testimonials-container .rhea-testimonials-carousel-nav' => 'background-color: {{VALUE}};',
				],
				'condition' => [
					'style' => 'carousel',
				],
		...
		$this->add_control(
			...
			[
				...
				'default'   => '',
				'selectors' => [
					'{{WRAPPER}} .rhea-testimonials-container .rhea-testimonials-carousel-nav:hover' => 'background-color: {{VALUE}};',
				],
				'condition' => [
					'style' => 'carousel',
				],
